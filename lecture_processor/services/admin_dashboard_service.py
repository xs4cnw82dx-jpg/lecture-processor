    ...
    try:
        ...
        return app_ctx.jsonify({
            ...
            'metrics': {
                ...
                'rate_limit_physio_transcription_429': rate_limit_counts['physio_transcription'],
                'rate_limit_voice_notes_429': rate_limit_counts['voice_notes'],
                'rate_limit_audio_import_429': rate_limit_counts['audio_import'],
                'rate_limit_lecture_download_429': rate_limit_counts['lecture_download'],
                'rate_limit_tools_transcribe_429': rate_limit_counts['tools_transcribe'],
                'rate_limit_verify_email_429': rate_limit_counts['verify_email'],
                'rate_limit_by_name': dict(rate_limit_counts),
                'rate_limit_429_total': sum(rate_limit_counts.values()),
            },
            'trends': {
                'labels': trend_labels,
