EXPECTED_ROUTES = [
    ...
    ('GET', '/api/books', 'books.library'),
    ('POST', '/api/books', 'books.library'),
    ('POST', '/api/books/share-session', 'books.share_session'),
    ('GET', '/api/books/fonts', 'books.book_fonts'),
    ('POST', '/api/books/export', 'books.export_book'),
    ('GET', '/api/books/<book_id>', 'books.book'),
    ('PUT', '/api/books/<book_id>', 'books.book'),
    ('PATCH', '/api/books/<book_id>', 'books.book'),
    ('GET', '/api/books/<book_id>/revision', 'books.revision'),
    ('POST', '/api/books/<book_id>/lease', 'books.lease'),
    ('GET', '/api/books/<book_id>/sharing', 'books.sharing'),
    ('POST', '/api/books/<book_id>/sharing', 'books.sharing'),
    ('GET', '/api/books/<book_id>/comments', 'books.comments'),
    ('POST', '/api/books/<book_id>/comments', 'books.comments'),
    ('GET', '/api/books/<book_id>/history', 'books.history'),
    ('POST', '/api/books/<book_id>/history', 'books.history'),
    ('POST', '/api/books/<book_id>/assets', 'books.upload_asset'),
    ('GET', '/api/books/<book_id>/backup', 'books.backup'),
    ('GET', '/api/books/<book_id>/assets/<asset_id>', 'books.asset'),
    ('DELETE', '/api/books/<book_id>/assets/<asset_id>', 'books.asset'),

    ('GET', '/', 'pages.index'),
    ('GET', '/admin', 'pages.admin_dashboard'),
    ('GET', '/admin/workout', 'pages.admin_workout_page'),
    ('GET', '/admin/workout/service-worker.js', 'pages.workout_service_worker'),
    ...
    ('GET', '/api/admin/workout/bodyweight', 'admin_api.workout_list_bodyweight'),
    ('PUT', '/api/admin/workout/bodyweight', 'admin_api.workout_upsert_bodyweight'),
    ('GET', '/api/admin/workout/bootstrap', 'admin_api.workout_bootstrap'),
    ('POST', '/api/admin/workout/cycles', 'admin_api.workout_start_cycle'),
    ('POST', '/api/admin/workout/cycles/reset', 'admin_api.workout_reset_cycle'),
    ('GET', '/api/admin/workout/exercises', 'admin_api.workout_list_exercises'),
    ('POST', '/api/admin/workout/exercises', 'admin_api.workout_create_exercise'),
    ('PATCH', '/api/admin/workout/exercises/<exercise_id>', 'admin_api.workout_update_exercise'),
    ('GET', '/api/admin/workout/occurrences', 'admin_api.workout_list_occurrences'),
    ('PATCH', '/api/admin/workout/occurrences/<occurrence_id>', 'admin_api.workout_update_occurrence'),
    ('PUT', '/api/admin/workout/profile', 'admin_api.workout_update_profile'),
    ('POST', '/api/admin/workout/program/restore', 'admin_api.workout_restore_program'),
    ('GET', '/api/admin/workout/routines', 'admin_api.workout_list_routines'),
    ('POST', '/api/admin/workout/routines', 'admin_api.workout_create_routine'),
    ('PATCH', '/api/admin/workout/routines/<routine_id>', 'admin_api.workout_update_routine'),
    ('DELETE', '/api/admin/workout/routines/<routine_id>', 'admin_api.workout_delete_routine'),
    ('POST', '/api/admin/workout/routines/<routine_id>/duplicate', 'admin_api.workout_duplicate_routine'),
    ('GET', '/api/admin/workout/sessions', 'admin_api.workout_list_sessions'),
    ('POST', '/api/admin/workout/sessions', 'admin_api.workout_start_session'),
    ('PATCH', '/api/admin/workout/sessions/<session_id>', 'admin_api.workout_update_session'),
    ('POST', '/api/admin/workout/sessions/<session_id>/discard', 'admin_api.workout_discard_session'),
    ('POST', '/api/admin/workout/sessions/<session_id>/finish', 'admin_api.workout_finish_session'),
    ('POST', '/api/admin/workout/shares', 'admin_api.workout_create_share'),
    ('DELETE', '/api/admin/workout/shares/<token>', 'admin_api.workout_revoke_share'),
    ('PUT', '/api/admin/workout/start-tests', 'admin_api.workout_update_start_tests'),
    ('GET', '/api/admin/workout/statistics', 'admin_api.workout_statistics'),
    ('GET', '/api/workout-shares/<token>', 'admin_api.workout_public_share'),
    ...
    ('GET', '/workout-shares/<token>', 'pages.workout_share_page'),
